...
def scada_tags():
    ...
    #     rows_to_copy['Parent Asset Name'] = rows_to_copy['Parent Asset Name'].apply(lambda x: x.replace('Test_P_ValveSO', instance))
    #     rows_to_copy['RealtimeDataSourceName (iFix tag Id)'] = rows_to_copy['RealtimeDataSourceName (iFix tag Id)'].apply(lambda x: x.replace('Test_P_ValveSO', instance))
    #     rows_to_copy['HistoricalDataSourceName'] = rows_to_copy['HistoricalDataSourceName'].apply(lambda x: str(x))
    #     rows_to_copy['HistoricalDataSourceName'] = rows_to_copy['HistoricalDataSourceName'].apply(lambda x: x.replace('Test_P_ValveSO', instance))
